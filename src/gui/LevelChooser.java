...
public class LevelChooser {
    ...
    public LevelChooser(Display display, ClickBehavior easyButtonBehavior,ClickBehavior mediumButtonBehavior, ClickBehavior difficultButtonBehavior) {
        ...
        this.easyLevel = new Button(title.getXCentered(), (double) display.getGCanvas().getHeight() * 2 / 3, "Easy",easyButtonBehavior);
        this.mediumLevel = new Button(title.getXCentered() + title.getWidth() / 2, (double) display.getGCanvas().getHeight() * 2/3, "Medium", mediumButtonBehavior);
        this.difficultLevel = new Button(title.getXCentered() + title.getWidth(), (double) display.getGCanvas().getHeight() * 2 / 3, "Difficult", difficultButtonBehavior);
    }
